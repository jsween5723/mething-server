...
public class MeetingController {
  ...
  public BaseResponse<Detail> getDetail(@PathVariable UUID id, Member user,
    ...
    return new BaseResponse<>(meetingMapper.toDetail(meeting, user instanceof Student student ? student : null));
  }
  ...
  public BaseResponse<Boolean> request(@PathVariable UUID id, @Valid @RequestBody MeetingDto.Request dto,
                      Student member) {
  ...
  public BaseResponse<CustomSlice<MeetingRequestDto.Detail>> searchRequestsWithMeeting(@PathVariable UUID id, MeetingRequestDto.SearchCondition condition, Member user,
                                                                         Pageable pageable) {
    Meeting meeting = meetingService.find(id);
