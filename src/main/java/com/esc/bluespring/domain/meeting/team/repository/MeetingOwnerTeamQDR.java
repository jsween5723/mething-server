...
public class MeetingOwnerTeamQDR {
    ...
    public ConstructorExpression<TeamDto.MainPageListElement> toMainPageListElement(
        ...
        return Projections.constructor(MainPageListElement.class, team.id, team.title, team.introduce, universityQDR.toMainPageListElement(team.representedUniversity), team.participants);
    }
}
