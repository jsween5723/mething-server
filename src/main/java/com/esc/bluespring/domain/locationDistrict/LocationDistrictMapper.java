...
import com.esc.bluespring.domain.locationDistrict.classes.LocationDistrictIndex;
...
public abstract class LocationDistrictMapper {
    ...
    List<LocationDistrict> toEntitiesWithMajorCSV(List<CSVRecord> records) {
